...
| 2      | Resolvers (KPN, Microsoft) | Each resolver confirms ownership of their respective instance. KPN confirms the phone numbers, Microsoft confirms the email address. | On-chain (credentials)                           |
